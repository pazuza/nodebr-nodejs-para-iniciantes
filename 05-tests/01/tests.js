...
//Instalamos a dependência nock para simular requisições
const nock = require('nock');

describe('Star Wars Tests', function () { //Não usar  () => pq senão dá ruim
    this.beforeAll( function () { //Não usar  () => pq senão dá ruim
        const response = {
            "count"   : 1,
            "next"    : null,
            "previous": null,
